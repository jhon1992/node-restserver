...
app.post('/usuario', [validateToken, validateAdminRole], function(req, res) {
    let body = req.body;
...
app.put('/usuario/:id', [validateToken, validateAdminRole], function(req, res) {
...
app.delete('/usuario/:id', [validateToken, validateAdminRole], function(req, res) {
    let id = req.params.id;
